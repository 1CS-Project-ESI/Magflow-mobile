...
class _NotificationPageState extends State<NotificationPage> {
  ...
  Future<void> _fetchNotifications() async {
    ...
    if (_userRole == 'magasinier') {
      url = 'http://$backendIP:4000/api/notifications/magasinier/$_id';
    } else if (_userRole == 'structureresponsable') {
      url = 'http://$backendIP:4000/api/notifications/responsable/$_id';
    } else if (_userRole == 'director') {
      url = 'http://$backendIP:4000/api/notifications/directeur/$_id';
    } else if (_userRole == 'consumer') {
      url = 'http://$backendIP:4000/api/notifications/consommateur/$_id';
    } else {
      url = 'http://$backendIP:4000/api/notifications/user/$_id';
