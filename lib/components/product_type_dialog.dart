...
//     return AlertDialog(
//       title: Text('Select Command Type'),
//       content: Column(
      ...
      content: Column(
        ...
        children: [
          ElevatedButton(
            ...
            child: Text('Decharge',style: TextStyle(color: Colors.black),),
          ),
          SizedBox(height: 10),
          ElevatedButton(
            onPressed: () {
            ...
            child: Text('Interne',style: TextStyle(color: Colors.black),),
          ),
          SizedBox(height: 16),
          ElevatedButton(
            onPressed: _commandType != null
                ? () async {
                    await _createCommand(context);
            ...
            child: Text('Create Command',style: TextStyle(color: Colors.white),),
          ),
        ],
      ),
    );
